...
function InputOTPSlot({ index, className, ...props }: React.ComponentProps<"div"> & { index: number }) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-11 items-center justify-center rounded-lg border border-input bg-card text-lg font-medium tabular-nums shadow-sm transition-all outline-none",
